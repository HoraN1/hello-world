from word_game_Scrabble import *
import time
...
def playGame(wordList):
    ...
    while True:
        ...
        if user_choice == 'e':
            break
        while user_choice == 'n' or (rounds_games != 0 and user_choice == 'r'):
            print("Enter u to have yourself play, c to have the computer play:", end='')
            user_second_choice = input()
            if user_second_choice == 'u':
                playHand(hand, wordList, n)
                break
            if user_second_choice == 'c':
                compPlayHand(hand, wordList, n)
                break
            if user_second_choice not in ("u", "c"):
